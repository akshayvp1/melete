...
const store = {
  getState: () => ({
    tempUser: {
      tempUser: { name: 'Admin', role: 'Administrator', profileImage: '' },
    },
  }),
};
...
const AdminDashboardLayout: React.FC<AdminDashboardLayoutProps> = ({ children }) => {
  ...
  const navigationItems: NavItem[] = [
    ...
    { icon: Users, label: 'Counsellor Management', path: '/dashboard/admin-dashboard/counsellors', mobileVisible: true },
