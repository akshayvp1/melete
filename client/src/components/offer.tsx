...
const Briefcase: React.FC<IconProps> = (props) => (
  <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7h-16a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2v-10a2 2 0 00-2-2zM12 14h.01" />
...
const WhatWeOffer: React.FC = () => {
  ...
  const categories: Category[] = [
    ...
    },
    {
      ...
      image: categoryImages.professionals,
      icon: Briefcase,
    },
    {
      ...
      image: categoryImages.institutions,
      icon: Building,
    },
  ];
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 id="offer-heading" className="text-3xl md:text-4xl font-bold text-[#015F4A] mb-6">
            What We Offer
          </h2>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            MELETE provides holistic mental health solutions, including expert consultations,
            guided yoga and meditation, soothing relaxation music, and personalized wellness plans.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <category.icon className="w-8 h-8 text-[#015F4A] mr-3" aria-hidden="true" />
                  <h3 id={`category-${index}`} className="text-xl font-semibold text-[#015F4A]">
                    {category.title}
                  </h3>
                </div>
