...
// import { LayoutDashboard, Users, HelpCircle, LogOut, ChevronsLeft, ChevronsRight } from 'lucide-react';
...
//     { icon: LayoutDashboard, label: 'Dashboard', path: '/dashboard/admin-dashboard/home', mobileVisible: true },
//     { icon: Users, label: 'Counsellor Management', path: '/dashboard/admin-dashboard/counsellorMangement', mobileVisible: true },
//     { icon: HelpCircle, label: 'Help', path: '/dashboard/admin-dashboard/help', mobileVisible: true },
//   ];
...
const AdminDashboardLayout: React.FC<AdminDashboardLayoutProps> = ({ children }) => {
  ...
  const navigationItems: NavItem[] = [
    ...
    { 
      ...
      path: '/dashboard/admin-dashboard/add-counsellor', 
      mobileVisible: true 
    },
    { 
      icon: HelpCircle, 
      label: 'Help', 
      path: '/dashboard/admin-dashboard/help', 
      mobileVisible: true 
    },
  ];
